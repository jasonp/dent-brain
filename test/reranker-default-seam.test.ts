 ...
 * off `zeroentropyai:zerank-2`; this fork's replacement is `cohere:rerank-v3.5`
 * (`DEFAULT_RERANKER_MODEL` in src/core/ai/defaults.ts).
...
describe('DEFAULT_RERANKER_MODEL seam (#3657, flipped v0.48.2)', () => {
  ...
  test('the default IS the recommended new-install reranker (cohere) and is NOT on the sunset list', () => {
