...
| Command | Scope | When |
|---|---|---|
| `bun run test` | Parallel unit fast loop (8-shard), then `*.serial.test.ts`. Excludes slow + e2e. **~23 min** (10,667 tests; measured 2026-08-11). | Not an inner edit loop any more — run targeted files while iterating, this before pushing. |
