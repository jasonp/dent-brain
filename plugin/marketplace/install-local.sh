#!/usr/bin/env bash
# Dent The Future, Inc. Brain plugin — Code-mode local installer (v0.37.2).
#
...
echo "Installing $PLUGIN_NAME plugin v0.37.2 via Claude Code marketplace"
...
FREEFORM_REMOVED=0
for skill in dent-setup dent-append-evidence dent-enrich dent-resolve-entity dent-onboard-teammate dent-add-ingestor dent-extensions dent-tell-me-about; do
